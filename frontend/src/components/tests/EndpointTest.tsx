...
const performTests = (props: EndpointTestProps, setTestResults: Function) => {
    ...
    let testData: GreenhouseData = {
        ...
        GWHAlter: "(80,5)",
        AlterBedachungsmaterial: "(40,6)",
        AlterStehwandmaterial: "(10,7)",
        AlterEnergieschirm: "(20,8)",
        Stehwandhoehe: "(30,9)",
        Laenge: "(50,10)",
        Breite: "(30,11)",
        Kappenbreite: "(2,12)",
        ...
        Vorwegbreite: "(4,15)",
        AlterTransportsystem: "(30,16)",
        AlterKultursystem: "(30,17)",
        AlterZusaetzlichesHeizsystem: "(30,18)",
