        ...
        if(selectedGreenhouse != null && dataset.datasets != "" && typeof dataset.datasets != "string") {
            ...
            setInputFieldData({
                companyInformation: {
                    ...
                    land: parseSelectionTuple(initialDataset.Land) ?? inputFieldData.companyInformation.land,
                    region: parseSelectionTuple(initialDataset.Region) ?? inputFieldData.companyInformation.region,
                ...
                waterUsage: {
                    ...
                    vorlaufmengeAnteile: parseSelectionTuple(initialDataset.VorlaufmengeAnteile) ?? inputFieldData.waterUsage.vorlaufmengeAnteile,
